  ...
  <header class='site-header' id='site-header'>
    <div class='site-wrapper'>
      <div class='header-inner'>
        ...
        <!-- Desktop Navigation (Configurable via Layout > LinkList1) -->
        <b:section class='nav-menu-section' id='nav-menu-section' maxwidgets='1' name='Menu Điều Hướng Chính (Header)' showaddelement='yes'>
                ...
                <ul class='nav-menu' id='nav-desktop-menu'>
                  <b:if cond='data:links and not data:links.empty'>
                    <b:loop values='data:links' var='link'>
                      <li>
                        <a expr:href='data:link.target' data-bilingual='true'><data:link.name/></a>
                      </li>
                    </b:loop>
                  <b:else/>
  ...
  <footer class='site-footer' id='site-footer'>
    ...
    <div class='site-wrapper'>
      <div class='footer-tier1'>
        ...
        <!-- ── CỘT 2: CHÍNH SÁCH & PHÁP LÝ (Cấu hình qua Bố cục > LinkList3) ── -->
        <b:section id='footer-legal-section' class='footer-section-col' name='Footer: Cột 2 (Chính Sách &amp; Minh Bạch)' maxwidgets='1' showaddelement='yes'>
          <b:widget id='LinkList3' type='LinkList' version='2' title='⚖️ Chính Sách &amp; Minh Bạch'>
            ...
            <b:includable id='main'>
              <div class='footer-col-legal'>
                <h4 class='footer-col-title' data-bilingual='true'>
                  <b:if cond='data:title and not data:title.empty'><data:title/><b:else/>⚖️ Chính Sách &amp; Minh Bạch | Policies &amp; Transparency</b:if>
                </h4>
                <ul class='footer-links'>
                  <b:if cond='data:links and not data:links.empty'>
                    <b:loop values='data:links' var='link'>
                      <li><a expr:href='data:link.target'><span data-bilingual='true'><data:link.name/></span></a></li>
                    </b:loop>
                  <b:else/>
        ...
        <b:section id='footer-newsletter-section' class='footer-section-col' name='Footer: Cột 3 (Bản Tin &amp; Mạng Xã Hội)' maxwidgets='2' showaddelement='yes'>
          <b:widget id='HTML9' type='HTML' version='2' title='📬 Nhận Bài Viết Mới (Footer)'>
            <b:includable id='main'>
              <div class='footer-col-newsletter'>
                <h4 class='footer-col-title' data-i18n='newsletterTitle'>
                  <b:if cond='data:title and not data:title.empty'><data:title/><b:else/>📬 Nhận Bài Viết Mới</b:if>
                </h4>
                <b:if cond='data:content'>
          ...
          <b:widget id='LinkList4' type='LinkList' version='2' title='🌐 Kết Nối Mạng Xã Hội'>
            <b:widget-settings>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
              <div class='footer-col-social'>
                <div class='footer-social-grid'>
                  <b:if cond='data:links and not data:links.empty'>
                    <b:loop values='data:links' var='link'>
                      <a class='footer-social-icon' expr:href='data:link.target' target='_blank' rel='noopener noreferrer' expr:aria-label='data:link.name' expr:title='data:link.name'>
                        <data:link.name/>
                      </a>
                    </b:loop>
                  <b:else/>
    ...
    <div class='footer-bottom-wrapper'>
      <div class='site-wrapper'>
        <div class='footer-bottom'>
          ...
          <!-- Ở giữa: Bottom Navigation Menu (Cấu hình qua Bố cục > LinkList5) -->
          <b:section id='footer-bottom-menu-section' name='Footer Tầng 2: Menu Đáy Trang' maxwidgets='1' showaddelement='yes'>
            <b:widget id='LinkList5' type='LinkList' version='2' title='🔗 Menu Đáy Trang'>
              <b:widget-settings>
                <b:widget-setting name='sorting'>NONE</b:widget-setting>
              </b:widget-settings>
              <b:includable id='main'>
